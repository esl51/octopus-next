...
return [
    ...
    */
    ...
    'alias' => 'Поле :attribute может содержать только латинские буквы в нижнем регистре, цифры и нижнее подчеркивание.',
    ...
    */
    ...
    'attributes' => [
        ...
        'alias' => 'уникальный код',
        'property' => 'атрибут',
        'property_type_id' => 'тип атрибута',
        'property_group_id' => 'группа атрибутов',
    ],
