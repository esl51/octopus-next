...
return [
    ...
    */
    ...
    'extensions' => 'Файл в поле :attribute должен быть одного из следующих типов: :values.',
    ...
    'filable_type' => 'Выбранное значение для :attribute некорректно.',
    'filable_id' => 'Выбранное значение для :attribute некорректно.',
    'file_type' => 'Выбранное значение для :attribute некорректно.',
